...
namespace WarningSystem
{
    public partial class mychart : UserControl
    {
        ...
        public void Set_Four()
        {
            ...
            //chart1.Series[0].Name = "无";
            //chart1.Series[1].Name = "无";
           // chart1.Series[2].Name = "无1";
        ...
        public void Set_Series_Name1(string name)
        {
            chart1.Series[1].Name = name;
        }
        ...
        private bool PanDuan_Point(double x)
        {
